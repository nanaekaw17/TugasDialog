...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setAdapter(aa);// adapter diset buat dropdown
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(ListActivity.this,"Panjenengan Mboten Milih ", Toast.LENGTH_LONG).show();
            }
        });
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
             Toast.makeText(ListActivity.this,"Anda memilih = " + items[i], Toast.LENGTH_LONG).show();
             //toast digunakan untuk memanggil string yang ada di resource, untuk length_lonng akan menampilkan
                //lebih sekitar 5s kalau yang pendek setikar 2s.//
            }
        });
